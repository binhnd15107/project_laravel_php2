        ...
        <form action="{{route('adminNews.update')}}" method="post" enctype="multipart/form-data">
            ...
            <div>
                ...
                <div>
                    ...
                    <input size="80" name="title" value="{{$new->title}}" type="text" placeholder="nhập sản phẩm...">
                    @error('title')
                ...
                <div>
                    ...
                    <textarea name="content_one" placeholder="Thêm câu hỏi vào đây" name="content_one" id="summernote">
                ...
                <div>
                    ...
                    <textarea name="content_two" placeholder="Thêm câu hỏi vào đây" name="content_two" id="summernote2">\
                    {{$new->content_two}}
                    </textarea>
                    @error('content_two')
                    <div class="alert alert-danger">{{ $message }}</div>
            ...
            <div>
                ...
                <div>
                  ...
                  <br>
                    <br>
                    <img style="width:250px;height:150px" src="{{url('public/backend/img')}}/{{$new->img_poster}}" alt="">
                    @error('img_poster')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                    <br>
                ...
                <div>
                    ...
                    <br>
                    <br>
                    <img style="width:250px;height:150px" src="{{url('public/backend/img')}}/{{$new->img_content_two}}" alt="">
