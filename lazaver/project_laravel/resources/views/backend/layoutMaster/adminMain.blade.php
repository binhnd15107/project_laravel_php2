    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('admin.Main')}}">
                ...
                <div class="sidebar-brand-text mx-3">MẬTPET FAMILY</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{route('cartAdmin.show')}}"  >
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('drive.addImg')}}">Danh Sách</a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{route('adminUser.index')}}"  >
                    <i class="fas fa-fw fa-folder"></i>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{route('adminNews.index')}}"  >
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Tin Tức</span>
                </a>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form class="">
                        <div class="input-group">
                            <input size="50" name="search" type="text" class="form-control bg-light border-0 small" placeholder="Tìm kiếm..." aria-label="Search" aria-describedby="basic-addon2">
                    ...
                    <ul class="navbar-nav ml-auto">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{url('public/backend')}}/img/undraw_profile_1.svg" alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{url('public/backend')}}/img/undraw_profile_2.svg" alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{url('public/backend')}}/img/undraw_profile_3.svg" alt="...">
                        ...
                        @if(session()->has('user'))
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{session()->get('user')[0]->name}}</span>
