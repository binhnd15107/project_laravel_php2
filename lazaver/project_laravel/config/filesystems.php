...
return [
 ...
 'cloud'=>env('FILESYSTEM_CLOUD','s3'),
    'disks' => [
        ...
        'fourth_google' => [
            'driver' => 'google',
            'clientId' => env('FOURTH_GOOGLE_DRIVE_CLIENT_ID'),
            'clientSecret' => env('FOURTH_GOOGLE_DRIVE_CLIENT_SECRET'),
            'refreshToken' => env('FOURTH_GOOGLE_DRIVE_REFRESH_TOKEN'),
            'folderId' => env('FOURTH_GOOGLE_DRIVE_FOLDER_ID'),
        ],
